...
const Fourzerofour = () => {
    ...
    // page title
    document.title = "404 Error" + process.env.REACT_APP_PAGE_TITLE;
                ...
                <Row justify="center" align="middle" style={{ minHeight: '100vh' }}>
                    <Col xs={24} xl={14}>
                        <Card>
                            <Row gutter={[16, 24]}>
                                <Col xs={24} lg={10}>
                                    <div className="auth-card" style={{ backgroundColor: customStyles.colorPrimary, color: customStyles.colorBgContainer, height: "100%",  borderRadius: '6px' }}>
                                        <div style={{ display: 'flex', flexDirection: "column", alignItems: "space-between", padding: "20px",  justifyContent:'space-between', height:'100%' }}>
                                            ...
                                            <div>
                                                <p style={{ marginBottom: "0px" }}>&copy; {new Date().getFullYear()} Lizant. Crafted with <HeartOutlined style={{ color: customStyles.colorDanger }} /> by Themesbrand</p>
                                            </div>
                                        </div>
                                    </div>
                                </Col>
                                    ...
                                    <Card style={{ border: "0px" }}>
                                        ...
                                        <div className="text-center">
                                            <div style={{position: "relative"}}>
                                                <h4 style={{fontSize: "18px", textTransform: "uppercase", marginTop: "20px"}}>Opps, page not found</h4>
                                                <p style={{fontSize: "15px", marginBottom: "30px"}}>It will be as simple as Occidental in fact,
                                                    it will Occidental to an English person</p>
                                                <div>
                                                    <Button href="/dashboard" type='primary'><HomeOutlined />Back to home</Button>
                                                </div>
                                            </div>
                                        </div>
                                    </Card>
